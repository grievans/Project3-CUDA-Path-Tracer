...
<img width="750" alt="Screen Shot 2025-10-08 at 7 25 21 PM" src="https://github.com/user-attachments/assets/fc4e2d4b-f3dc-4898-a7af-18897c8544b4" />
...
<img width="750"  alt="Average kernel run times per frame for box and sphere scene with and without depth of field (lower is better)" src="https://github.com/user-attachments/assets/c3d5f171-2572-4a5c-ae4d-a820bd8035e2" />
...
<img width="1585"  alt="Average kernel run times per frame for scenes with and without motion blur keyframes (lower is better)" src="https://github.com/user-attachments/assets/60afa2b3-9828-4d55-a412-934ac1d76351" />
...
<img width="750"  alt="Average kernel run times per frame for glTF duck model (lower is better) (1)" src="https://github.com/user-attachments/assets/0677006e-5ab0-4859-ad2a-5f26b92125d4" />
...
<img width="750"  alt="Average run time per frame of shadeMaterial kernel for varying background environments (ms; lower is better)" src="https://github.com/user-attachments/assets/c4c9f7c8-2d35-4357-8e13-9418388cac20" />
...
<img width="500" alt="Average kernel run times per frame (summed over all depths) for Cornell box scene with and without stream compaction and material sorting (lower is better) (1)" src="https://github.com/user-attachments/assets/d5e23180-e55c-44d7-a4bf-765bf4ae99b5" />

<img width="500" alt="Average kernel run times for Cornell box scene at depth 5 and 6 with and without compaction and sorting (1)" src="https://github.com/user-attachments/assets/5017d7c7-a117-4f57-8f5d-711ba69cf013" />
...
<img width="500" alt="Average kernel run times per frame for bell model in open scene with and without stream compaction and material sorting (lower is better) (1)" src="https://github.com/user-attachments/assets/2387c62a-3ad5-4482-8833-4c6e0790cfed" />


<img width="500" alt="Average kernel run times per frame for bell model in closed scene with and without stream compaction and material sorting (lower is better) (1)" src="https://github.com/user-attachments/assets/d0fc8c51-8ea9-47a1-8b91-fb0b4886e2dc" />
...
<img width="500" alt="Average kernel run times per frame for closed bell scene with varying roulette thresholds (lower is better)" src="https://github.com/user-attachments/assets/a6c695d8-c5b5-4cb9-97de-db91d72de84c" />
