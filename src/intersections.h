...
__host__ __device__ float triangleIntersectionTestPretransformed(
    const Triangle& tri,
    const glm::vec3* vertPos, const glm::vec3* vertNorm,
    Ray r,
    glm::vec3& intersectionPoint,
...
__host__ __device__ bool intersectAABB(const Ray& r, const glm::vec3 bmin, const glm::vec3 bmax, float t);